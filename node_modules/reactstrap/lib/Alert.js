...
var Alert = function Alert(props) {
  ...
  var attributes = _objectWithoutProperties(props, ['className', 'tag', 'color', 'isOpen', 'toggle', 'children', 'transitionAppearTimeout', 'transitionEnterTimeout', 'transitionLeaveTimeout']);

  var classes = (0, _classnames2.default)(className, 'alert', 'alert-' + color, { 'alert-dismissible': toggle });
